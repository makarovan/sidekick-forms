...
## Environments
- Preview: https://main--sidekick-forms--makarovan.hlx.page/
- Live: https://main--sidekick-forms--makarovan.hlx.live/
...
1. Open the `sidekick-forms` directory in your favorite IDE and start coding :)
